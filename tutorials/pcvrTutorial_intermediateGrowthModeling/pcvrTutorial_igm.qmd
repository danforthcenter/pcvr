...
Hypothesis testing for frequentist non-linear growth models can be difficult. `pcvr` currently does not have specialized hypothesis testing functions for these models, but `car` and `nlraa` both support some testing.
