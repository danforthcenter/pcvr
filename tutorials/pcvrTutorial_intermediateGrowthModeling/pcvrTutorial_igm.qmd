...
## A note on GAMs {.smaller}

There is also limited support for [generalized additive models](https://en.wikipedia.org/wiki/Generalized_additive_model) in `pcvr`
...
Any of the 8 parameterized models shown can be specified easily using `growthSS`.
...
#| echo: true
#| eval: true
testGrowth(nlrq_ss, nlrq_fit, test_pars = "A")[[13]]
```
