...
noise <- do.call(rbind, lapply(1:30, function(i) {
  chngpt <- rnorm(2, 18, 2)
  rbind(
    data.frame(id = paste0("id_", i), time = 1:chngpt[1], group = "a", y = c(runif(chngpt[1] - 1, 0, 20), rnorm(1, 5, 1))),
...
noise2 <- do.call(rbind, lapply(1:30, function(i) {
  ...
  rbind(
    data.frame(id = paste0("id_", i), time = start1:40, group = "a", y = c(runif(length(start1:40), 15, 50))),
