...
bw.time(sv, mode="DAS", phenotype="area_pixels",
           group=c("barcode", "rotation"), plot = TRUE)$plot
```
...
#| echo: true
#| output-location: slide
bw.time(sv, mode="DAE", phenotype="area_pixels",
               cutoff=10, group=c("barcode", "rotation"), plot=TRUE)$plot
```
