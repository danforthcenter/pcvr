...
```{r}
test<-pwue(sv_ag, water, "area_pixels", "DAS", c("barcode"))
...
frem(sv_ag, des=c("genotype", "fertilizer"),
     phenotypes=c("area_pixels", "area_above_reference_pixels", "area_below_reference_pixels", 
                  ...
                  "ellipse_eccentricity_none", "ellipse_major_axis_degrees", "ellipse_minor_axis_pixels", 
...
sv_ag$height_cm <- sv_ag$height_pixels/42.5
```
