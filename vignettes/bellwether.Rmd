...
```{r}
pcvBox(sv_ag[sv_ag$genotype == "MM" & sv_ag$DAS == 15, ],
  x = "fertilizer", y = "area_cm2",
...
```{r, eval=FALSE}
brmPlot(fit,
  form = area_cm2 ~ DAS | barcode / group, df = ss$df,
...
```{r}
pcadf(hue_wide,
  cols = "hue_frequencies", color = c("genotype", "fertilizer"),
