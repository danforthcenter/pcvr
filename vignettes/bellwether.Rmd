...
The `pcvBox` function is a simple wrapper around ggplot and ggpubr functions that compares data with either T tests or Wilcox tests.
...
```{r}
mo17_area <- sv[sv$genotype=="Mo17" & sv$DAS > 18 & sv$fertilizer == 100, "area_cm2"]
B73_area <- sv[sv$genotype=="B73" & sv$DAS > 18 & sv$fertilizer == 100, "area_cm2"]
