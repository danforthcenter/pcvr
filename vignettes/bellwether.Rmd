...
Based on literature and observed trends there are 13 common growth models that `pcvr` supports. Six of those are shown here using the `growthSim` function and remaining options could be visualized in the same way.
