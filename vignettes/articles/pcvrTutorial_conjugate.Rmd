...
Note that the `conjugate` function outputs a `conjugate` class object. If you just print that object it will show the main results in a easily human-readable format.
