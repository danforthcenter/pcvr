...
Here our pWUE data look a lot like the original phenotype data. That's because the phenotype data are used as-is in the numerator, and for the most part we don't have drastic changes to the water transpiration (weight changes) over time.
...
`Note, need to update pwue docs for this part`
